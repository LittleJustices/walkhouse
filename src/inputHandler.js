class InputHandler {
    ...
    handleInput() {
        ...
        else if (JustDown(this.keys.numZero))       return gameState.state.numpadInputs.numZero;
        else if (JustDown(this.keys.enter))         return gameState.state.numpadInputs.enter;
        ...
        else if (JustDown(this.keys.space))         return gameState.state.wasdInputs.space;
        else if (JustDown(this.keys.shift))         return gameState.state.wasdInputs.shift;
